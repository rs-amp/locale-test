...
export declare class HalResource {
     ...
     * @hidden
     */
    protected performActionThatReturnsResource<T extends HalResource>(name: string, params: any, data: any, resourceConstructor: HalResourceConstructor<T>, method?: HttpMethod.POST | HttpMethod.PATCH): Promise<T>;
    /**
