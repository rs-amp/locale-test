...
export interface HalClient {
    ...
    performActionThatReturnsResource<T extends HalResource>(link: HalLink, params: any, data: any, resourceConstructor: HalResourceConstructor<T>, method: HttpMethod.POST | HttpMethod.PATCH): Promise<T>;
