...
declare abstract class BaseContentItem extends HalResource {
    /**
 ...
 */
export declare class FacetedContentItem extends BaseContentItem {
    /**
     * Content item schema
     */
    schema: string;
 ...
 */
export declare class ContentItem extends BaseContentItem {
    /**
 ...
 * @hidden
 */
export declare class ContentItemsFacets extends FacetsResponse<FacetedContentItem> {
    constructor(data?: any);
}
export {};
